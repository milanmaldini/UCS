...
xcopy "Ultrapowa Clash Server\bin\Release\tools\*.*" ucspackages\%1\tools
rem xcopy "Ultrapowa Clash Server\bin\Release\ucsdb" ucspackages\%1
rem xcopy ucsbuildsha.exe ucspackages\%1\tools
rem xcopy gen_patch.bat ucspackages\%1\tools
rem xcopy ucsgflzma.exe ucspackages\%1\tools
xcopy ucsdb.sql ucspackages\%1\tools
xcopy ucsdb ucspackages\%1
xcopy readme.txt ucspackages\%1
xcopy "Ultrapowa Clash Server\bin\Release\filter.ucs" ucspackages\%1