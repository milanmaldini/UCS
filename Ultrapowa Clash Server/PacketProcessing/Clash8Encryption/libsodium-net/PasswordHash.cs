...
namespace Sodiumc
{
    ...
    public class PasswordHash
    {
        ...
        public enum Strength
        {
            ...
            [Obsolete("Use Strength.Medium instead.")] Moderate,
        ...
        public static byte[] ScryptHashBinary(string password, string salt, Strength limit = Strength.Interactive,
        ...
        /// <exception cref="SaltOutOfRangeException"></exception>
        /// <exception cref="OutOfMemoryException"></exception>
        public static byte[] ScryptHashBinary(byte[] password, byte[] salt, Strength limit = Strength.Interactive,
            long outputLength = SCRYPT_SALSA208_SHA256_SALTBYTES)
        {
            int memLimit;
            long opsLimit;
        ...
        /// <exception cref="SaltOutOfRangeException"></exception>
        /// <exception cref="OutOfMemoryException"></exception>
        public static byte[] ScryptHashBinary(string password, string salt, long opsLimit, int memLimit,
            long outputLength = SCRYPT_SALSA208_SHA256_SALTBYTES)
        {
        ...
        public static string ScryptHashString(string password, long opsLimit, int memLimit)
        {
            ...
            var ret = SodiumLibrary.crypto_pwhash_scryptsalsa208sha256_str(buffer, pass, pass.LongLength, opsLimit,
                memLimit);
