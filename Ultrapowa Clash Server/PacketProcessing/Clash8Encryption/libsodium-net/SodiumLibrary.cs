...
namespace Sodiumc
{
    ...
    public static class SodiumLibrary
    {
        ...
        internal static LazyInvoke<_BeforeNm> _crypto_box_beforenm = new LazyInvoke<_BeforeNm>("crypto_box_beforenm",
            Name);
        ...
        internal static LazyInvoke<_AfterNm> _crypto_box_easy_afternm =
            new LazyInvoke<_AfterNm>("crypto_box_easy_afternm", Name);
        ...
        internal static LazyInvoke<_AfterNmOpen> _crypto_box_open_easy_afternm =
            new LazyInvoke<_AfterNmOpen>("crypto_secretbox_xsalsa20poly1305_open", Name);
        ...
        internal static _BeforeNm crypto_box_beforenm
        {
            get { return _crypto_box_beforenm.Method; }
        }
        ...
        internal static _AfterNm crypto_box_easy_afternm
        {
            get { return _crypto_box_easy_afternm.Method; }
        }
        ...
        internal static _AfterNmOpen crypto_box_open_easy_afternm
        {
            get { return _crypto_box_open_easy_afternm.Method; }
        }
        ...
        public static extern int crypto_secretbox_xsalsa20poly1305_open(byte[] outBuf, byte[] ciph, int ciphLen,
            byte[] nonce, byte[] sk);
        ...
        internal delegate int _AfterNm(byte[] cipherText, byte[] message, int messageLen, byte[] nonce, byte[] sharedkey
            );
        ...
        internal delegate int _AfterNmOpen(
            byte[] outBuffer, byte[] cipherText, long cipherTextLen, byte[] nonce, byte[] sharedKey);
