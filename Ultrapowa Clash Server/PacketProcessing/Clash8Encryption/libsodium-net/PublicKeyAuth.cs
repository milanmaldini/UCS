    ...
    public static class PublicKeyAuth
    {
        ...
        public static byte[] ConvertEd25519PublicKeyToCurve25519PublicKey(byte[] ed25519PublicKey)
        {
            ...
            if (ed25519PublicKey == null || ed25519PublicKey.Length != PUBLIC_KEY_BYTES)
                throw new KeyOutOfRangeException("ed25519PublicKey",
                    ed25519PublicKey == null ? 0 : ed25519PublicKey.Length,
        ...
        public static byte[] ConvertEd25519SecretKeyToCurve25519SecretKey(byte[] ed25519SecretKey)
        {
            ...
            if (ed25519SecretKey == null ||
                (ed25519SecretKey.Length != PUBLIC_KEY_BYTES && ed25519SecretKey.Length != SECRET_KEY_BYTES))
                throw new KeyOutOfRangeException("ed25519SecretKey",
                    ed25519SecretKey == null ? 0 : ed25519SecretKey.Length,
